...
const init_phones = ["HTH67"],                      // Optional. Which graphs to display on initial load. Note: Share URLs will override this set
      ...
      watermark_text = "AHS Grapher",               // Optional. Watermark appears behind graphs
      watermark_image_url = "",                     // Optional. If image file is in same directory as config, can be just the filename
      page_title = "AHS Grapher",                   // Optional. Appended to the page title if share URLs are enabled
      page_description = "The realest graphing tool on the internet.",
      ...
      extraEQBandsMax = 40,                         // Max EQ bands available
      extraToneGeneratorEnabled = true;             // Enable tone generator function

// Specify which targets to display
const targets = [
    { type:"User Target",    files:["WDYM Target"] },
];
...
let tutorialDefinitions = [
    ...
    },
    {
        name: 'Mid bass',
        width: '19.2%',
        description: 'Always an issue on most iems'
    },
    {
        name: 'Lower midrange',
        width: '17.4%',
    ...
    },
    {
        name: 'Upper midrange',
        width: "20%",
        description: '"Wide Soundstage"'
    },
    {
        name: 'Presence region',
        width: '6%',
        description: 'This place is important'
    },
    {
        name: 'Mid treble',
        width: '7.3%',
        description: '"All The tz, tsh, tss sounds"'
    },
    {
        name: 'Air',
        width: '10%',
